...
fetch("http://localhost:3000/Resource")
    ...
    .then(function (Resource) {
        ...
        document.querySelector("#resource-list").innerHTML = '<tr><td align="center">Mã nguyên liệu</td><td >Tên nguyên liệu</td><td align="center">Số lượng</td><td align="center">Đơn vị</td></tr>' + resource_list;
    });
...
moreButton.forEach(function(button)
{
    button.onclick = function(e){
        e.preventDefault();
        $('#resource-input-table').innerHTML += '<tr><td> <input type="text" name="" id="" /></td><td><input type="text" name="" id="" /></td><td><input type="number" name="" id="" /></td><td><input type="text" name="" id="" /></td><td><input type="number" name="" id="" /></td></tr>'
    }
})
